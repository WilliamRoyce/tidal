...
3. Key papers available locally:
   - Gertsenshtein: 2301.02072 (Domcke, simple derivation), 2310.04150 (Hwang-Noh, EM field definitions), 2004.02714 (Ejlli, exact solution), 2405.01407 (Palessandro 2024 — builds on Palessandro-Rothman 2023 PDU 40 101187; Hwang-Noh criticise that precursor for incorrect EM field definitions, noting the wrong equations only coincide with correct ones for plane GW in uniform B), 2406.17853 (Dandoy, GW constraints), 2507.16609 (Domcke, GW scattering), 2302.08186 (modified-gravity Gertsenshtein), 2405.11786 (Hwang-Noh, EH nonlinear)
