#!/usr/bin/env bash
# Phase E.T2 sup — Einstein-Cartan minimal (algebraic torsion masses only)
#
# Companion to e_t2_einstein_cartan_amp.sh — same theory, prior, geometry;
# likelihood minimizes P_max (suppression baseline).
