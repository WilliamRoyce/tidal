...
<!-- cspell:words xPand xMAG xBrauer TraceFree Pitrou Umeh Helpin Bertschinger xPert normu Weitzenböck -->
...
| `wolfram/RCSetup.wl` | shared setup: loads xPand first, FRW slicing with selectable normal norm, verdict / digest / export helpers | ours |
