...
def _wls_canonical_vard_eom_path(  # noqa: C901, PLR0912, PLR0914, PLR0915
    ...
    lines.extend(
        [
            "",
            f"lagForCanon = {p}Lagrangian;",
            "(* NOTE: SeparateMetric is NOT applied before VarD.                    *)",
            "(* The supervisor (SphericalEuclidean.m:131) and our linearization    *)",
            "(* path (_derive.py:2070) both VarD the compact Lagrangian without   *)",
            "(* SeparateMetric. It's applied during component projection inside    *)",
            "(* DecomposeToComponents (SplinterToArray calls SeparateMetric).      *)",
            "(* Removing it reduces abstract EOM term count significantly.         *)",
            "",
