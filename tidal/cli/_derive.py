...
def _wls_constraint_elimination() -> list[str]:
    ...
    return [
        ...
        "(* coefficients.                                                    *)",
        "(* NOTE: ParseHamiltonianExpression may emit non-fatal Set::write   *)",
        "(* errors for temporal gauge fields (e.g. gwzH0-H3) — cosmetic,    *)",
        "(* results are correct.                                             *)",
        'Print[""];',
        ...
        "      Continue[]",
        "    ];",
        "    (* Also detect field products: f[...]*g[...] *)",
        "    Module[{fieldTerms},",
        "      fieldTerms = Cases[eq,",
        "        f_Symbol[___] /; MemberQ[fieldFuncList, f],",
        "        {0, Infinity}];",
        "      If[Length[fieldTerms] >= 2,",
