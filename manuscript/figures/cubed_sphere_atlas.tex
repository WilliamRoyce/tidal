...
\begin{tikzpicture}[
  ...
  %------------------------------------------------------------------
  \draw[AxisLine!70, thin] (0,0,0) -- (1,0,0);
  \draw[AxisLine!70, thin] (0,0,0) -- (0,1,0);
  \draw[AxisLine!70, thin] (0,0,0) -- (0,0,1);
  ...
  \foreach \zline in {-0.5, 0, 0.5}{
    \draw[FaceLine!55, very thin]
      plot[domain=-1:1, samples=24, smooth]
        ({\x/sqrt(\x*\x + 1 + \zline*\zline)},
         {-1/sqrt(\x*\x + 1 + \zline*\zline)},
         {\zline/sqrt(\x*\x + 1 + \zline*\zline)});
  }
  % Vertical lines (constant x on the cube face)
  \foreach \xline in {-0.5, 0, 0.5}{
    \draw[FaceLine!55, very thin]
      plot[domain=-1:1, samples=24, smooth]
        ({\xline/sqrt(\xline*\xline + 1 + \x*\x)},
         {-1/sqrt(\xline*\xline + 1 + \x*\x)},
         {\x/sqrt(\xline*\xline + 1 + \x*\x)});
  }
  ...
  \draw[TileLine, very thick]
    plot[domain=\ttileLo:\ttileHi, samples=16, smooth]
      ({\ttileLo/sqrt(\ttileLo*\ttileLo+1+\x*\x)},
       {-1/sqrt(\ttileLo*\ttileLo+1+\x*\x)},
       {\x/sqrt(\ttileLo*\ttileLo+1+\x*\x)});
  % Edge at x = \ttileHi
  \draw[TileLine, very thick]
    plot[domain=\ttileLo:\ttileHi, samples=16, smooth]
      ({\ttileHi/sqrt(\ttileHi*\ttileHi+1+\x*\x)},
       {-1/sqrt(\ttileHi*\ttileHi+1+\x*\x)},
       {\x/sqrt(\ttileHi*\ttileHi+1+\x*\x)});
  % Edge at z = \ttileLo
  \draw[TileLine, very thick]
    plot[domain=\ttileLo:\ttileHi, samples=16, smooth]
      ({\x/sqrt(\x*\x+1+\ttileLo*\ttileLo)},
       {-1/sqrt(\x*\x+1+\ttileLo*\ttileLo)},
       {\ttileLo/sqrt(\x*\x+1+\ttileLo*\ttileLo)});
  % Edge at z = \ttileHi
  \draw[TileLine, very thick]
    plot[domain=\ttileLo:\ttileHi, samples=16, smooth]
      ({\x/sqrt(\x*\x+1+\ttileHi*\ttileHi)},
       {-1/sqrt(\x*\x+1+\ttileHi*\ttileHi)},
       {\ttileHi/sqrt(\x*\x+1+\ttileHi*\ttileHi)});
