...
% --- Modal solver ---
\node[solver=Purple, below=of d1] (modal)
    {Modal solver};
...
% --- IDA (constraint) ---
\node[solver=Orange, below=of d2] (ida1) {IDA};
...
% --- IDA (first-order) ---
\node[solver=Orange, below=of d3] (ida2) {IDA};
...
% --- IDA (dissipation) ---
\node[solver=Orange, below=0.6cm of d4] (ida3) {IDA};

% --- Default: CVODE ---
\node[solver=Green, right=0.6cm of d4] (cvode)
    {CVODE};
