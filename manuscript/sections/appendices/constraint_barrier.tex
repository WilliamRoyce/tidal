...
base-theory equations of motion is equivalent to a canonical field redefinition
$\varphi^{\mathcal{I}} \to \varphi^{\mathcal{I}} + \varepsilon\,\delta\varphi^{\mathcal{I}}$
in the action.
The redefinition preserves the Poisson bracket structure, so physical observables take
identical form before and after the substitution.
The original higher-derivative Lagrangian and the perturbatively reduced one are
therefore physically equivalent within the perturbative regime, and the order-by-order
expansion of the equations of motion reproduces the physical predictions of
$\mathcal{L}$ to first order in $\varepsilon$.
...
equivalence breaks down; this case is described below.
...
which introduces each time-derivative order as a separate dynamical variable
$Q_n^{\mathcal{I}} \equiv \partial_t^n\varphi^{\mathcal{I}}$ for $n = 0, 1, \ldots, N-1$
with $N$ the order of the highest time derivative in $\mathcal{L}$, yields a first-order
system, but the promoted ghost modes of Ostrogradsky's theorem then appear as live
degrees of freedom and produce unphysical exponential growth in long-time simulation.
