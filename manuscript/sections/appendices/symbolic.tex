...
The symbolic computation produces, from a Lagrangian, a background
ansatz, and a parameter set, a JSON specification of the linearised
...
\cref{NumericalEvolution} is the output of this pipeline.
...
cache at every later stage that needs them.
