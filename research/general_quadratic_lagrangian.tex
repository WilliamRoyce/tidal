...
\noindent The parity-odd derivative sectors
($\eps \cdot \del T \times F$: 6 terms,
$\eps \cdot \Rt \times \del T$: 36 terms,
$\eps \cdot (\del T)^2$: 38 terms) and parity-odd cubic sectors
($\eps \cdot \Rt \times F^2$: 12 terms,
$\eps \cdot T^2 \times F$: 15 terms,
$\eps \cdot F^2 \times \del T$: 18 terms)
are provided in the supplementary data file
\texttt{explicit\_terms\_tex.txt} (195 terms total).
