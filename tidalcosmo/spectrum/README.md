...
> **Directory boundary from H4 (2026-08-31); internals settled by H6 + H8.** The H4 study
...
> `docs/cosmology/spectrum_design.md` and `stage1_engineering_plan.md`. Do not reopen them from this file.
>
