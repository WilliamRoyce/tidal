...
> **Directory boundary from H4 (2026-08-31); internals settled by H1.** The H4 study
...
> `docs/cosmology/torc_pipeline_audit.md` §7 (the CAMB seam and the optional hook). Do not reopen them from this file.
