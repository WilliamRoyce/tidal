...
| 28789437 | T4 Ricci-EM | **Phase 6.C D1 amp clean (std)** | PENDING | — | icelake standard 6h; canonical probe gate + Hwang–Noh; same priors as 28520217; k_IC = 2π/100 (canonical). |
...
| 28799598 | T4 Ricci-EM | **Phase 6.C D1 sup clean (INTR)** | RUNNING | — | INTR, campaign=d1_sup_intr. Canonical settings (grid 256, bounds 0:100, k_IC=2π/100, P_max:minimize). Started 20:35 UTC 2026-05-03. |
