...
| 28842500 | T4 Ricci-EM | **Phase 6.D Track 1 sup (INTR cross-check)** | PENDING | — | INTR, ntasks=76, campaign=d1_sup_track1_intr. Same priors / settings / probe as 28841945. Resume on timeout. Whichever (std or INTR-resumed) converges first becomes primary. |
