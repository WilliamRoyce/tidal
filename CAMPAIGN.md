...
| 28838011 | T4 Ricci-EM | **Phase 6.D Track 1 amp (probe-only, k_IC=2.0)** | RUNNING | — | INTR, ntasks=76. k_IC=2.0 matches 28520217 exactly; canonical probe gate added. No constraints. Predicted log Z ≈ −2.297 (Phase 6.B: Δlog Z = −0.036). |
