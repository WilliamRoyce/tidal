...
- [ ] **Re-run 6.C.2 hi-res D1 amp under τ=0.15** (next action; #340 stays open until done). Pre-requisite: `bash scripts/hpc_refresh_venv_tar.sh` (HPC venv tarball must include v0.38.6 to ship the new probe). Expected outcome: MAP off the γ≈0.27 ridge, A_max ≲ 20 from the most-perturbative MAP. Paired B = 3.1×10⁻⁵ qualitative verdict unchanged.
- Notes:
