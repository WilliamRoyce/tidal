...
| 28841945 | T4 Ricci-EM | **Phase 6.D Track 1 sup (probe-only, k_IC=2.0)** | PENDING | — | icelake standard 6h, ntasks=76. k_IC=2.0 matches 28519675 exactly; canonical probe gate added. P_max:minimize. No constraints. Expected log Z ≈ +15.9 (small probe-only shift). Pairs with 28838011 to give a clean Track 1 Bayes factor at the corrected probe. |
