...
| 28859477 | T1 Dark-Photon-Plasma | **Phase 6.E Stage A v5 sup canonical (INTR)** | PENDING | — | INTR, ntasks=76. Reproduces 28477675 exactly (grid 64, bounds 0:50, k_IC=2.0, nlive=400, num-repeats=5, prec=0.01, priors unchanged). Canonical probe now default — no flag change. Expected: log Z ≈ +0.50 (Phase 6.B predicted Δ=−0.154 nats from original +0.654). MAP (mA₂=+0.969, δm=−0.446, ξ=+0.796, α₃=+0.001) survives probe at γ_eff=0.101. |
