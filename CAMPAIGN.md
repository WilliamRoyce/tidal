...
- [x] **HPC venv tarball refreshed 2026-05-05** with v0.38.6 (τ=0.15 probe shipped). 254 MB site-packages tar, pypolychord verified present.
- [ ] **Re-run 6.C.2 hi-res D1 amp under τ=0.15** — submitted as **28881154** (INTR, ntasks=76, DiRAC SL3, ~20 min expected). Same priors/grid/k_IC/B₀/t_end as 28789437/28789579; only the probe threshold differs. Expected outcome: MAP off the γ≈0.27 ridge, A_max ≲ 20 from the most-perturbative MAP. Paired B = 3.1×10⁻⁵ qualitative verdict unchanged. #340 closes when this lands.
- Notes:
