...
\node[stage=Gray] (entry)
    {\textbf{Constraint IC Solver}\\[1pt]
     \scriptsize ensure consistent initial conditions};

% ===================================================================
% PHASE 1: Standard constraints
% ===================================================================
\node[stage=Blue, below=of entry, text width=3.8cm] (ph1)
    {\textbf{Phase 1: Standard constraints}\\[1pt]
     \scriptsize constraint equations present};

\node[decision, below=of ph1] (d1)
    {Self-term\\present?};
...
% Tier 1
\node[stage=Green, right=of d2] (t1)
...
% Tier 2
\node[stage=Purple, below=of d2] (t2)
...
% ===================================================================
\node[stage=Pink, below=1.0cm of t2, text width=4.2cm] (ph2)
...
% ===================================================================
\node[check, below=of ph2, text width=4.6cm] (ph3)
    {\textbf{Phase 3: Verification}\\[2pt]
     evaluate all constraint residuals\\
     halt with error if violated\\
     (optional: proceed with warning)};
...
% ===================================================================
\node[check, left=of d2, text width=3.2cm] (selmethod) {%
    \textbf{Auto-select tier}\\[2pt]
    chooses method based\\
    on BCs + coefficient type};
