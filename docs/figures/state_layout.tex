...
\begin{tikzpicture}[
    ...
    fieldslot/.style={slot},
    velslot/.style={slot},
    conslot/.style={slot, draw=OrangeLine, dashed},
...
\begin{tabular}{@{}l l@{}}
    ...
    \tikz\fill[BlueFill, fill opacity=0.4, draw=black!60]
        (0,0) rectangle (0.5,0.25); & Field ($q$, \texttt{kind="field"}): $\partial_t^{\geq 1}$ \\[2pt]
    \tikz\fill[PurpleFill, fill opacity=0.3, draw=black!60]
        (0,0) rectangle (0.5,0.25); & Velocity ($v = dq/dt$): $\partial_t^{\geq 2}$ (wave equation) \\[2pt]
    \tikz\fill[OrangeFill, fill opacity=0.4, draw=OrangeLine, dashed]
        (0,0) rectangle (0.5,0.25); & Constraint: $\partial_t^{0}$ (no velocity, algebraic) \\
\end{tabular}};
