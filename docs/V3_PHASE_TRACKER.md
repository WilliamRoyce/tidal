...
| B.5-pub | D2.0–D2.3 v3 publication pass (50×ndim) | 🟡 pending | 6 chains remaining: D2.0 amp pub (nlive=250), D2.1 amp pub (300), D2.2 amp pub (400), D2.2 sup pub (400), D2.3 amp pub (450), D2.3 sup pub (450). Already done: D2.0 sup pub (29471255, logZ=+5.837±0.143, ESS=2404), D2.1 sup pub (29471255, logZ=+2.524±0.158, ESS=2895). Batch scripts: `v3_permissive/run_pub_batch_*.sh`. Target: 3–4 INTR sessions. |
