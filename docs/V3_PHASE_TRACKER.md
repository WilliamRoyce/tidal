...
| 9 | T7 Complete-Even PGT | 18 | 450 | 900 | 36 | 64 | torsion_gertsenshtein_complete_even.json | ⏳ re-deriving (2026-05-23, no R×R) |
...
| B.5-t7 | T7 Complete-Even PGT landscape | ⏳ in progress | Re-derivation of `theory_complete_even.toml` running 2026-05-23 (~5 min). **No R×R terms** (blocked by pipeline). T7 = T5 + chi1-10, ndim=18, nlive=450, num_repeats=36. Script: `scripts/hpc_templates/polychord_intr_t7_landscape.sbatch`. Submit after derivation completes. |
