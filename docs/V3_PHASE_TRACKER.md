...
| 9 | T7 Complete-Even PGT | 18 | 450 | 900 | 36 | 64 | torsion_gertsenshtein_complete_even.json | ✅ B.5-t7 landscape done (29588680, null) |
| 10 | T8 Complete-Odd PGT | ~54 | ~1350 | ~2700 | ~108 | 64 | torsion_gertsenshtein_complete_odd.json | ⏸ deferred to Phase E (T6 null) |
...
**T8 design:** T6 base + xt1–xt36 (ε·R̃×∂T sector, 36 terms). No ε·R×R — blocked. Conditional on T6 signal. `complete_odd.json` derived 2026-05-23 (38 fields, 48 H-terms). Deferred to Phase E.
...
| B.5-t6 | T6-minimal + T6 parity-odd landscape pass | ✅ done (2026-05-23) | **T6 full fresh: 29567416** (1hr INTR, TIMEOUT). logZ=-15.07±0.022 (amp), -15.17±0.023 (sup). **100% floor hits** — all 1040/1033 dead points in floor noise band [-17.8,-13.9]. Stable region (d19=d20=d21=0) has measure zero in continuous prior → plane-wave setup cannot survey T6. **NULL result**; Phase E (localised geometry) required for meaningful T6/T8 survey. T6-minimal: 29515407/t6_minimal_amp/sup (logZ see stats; corner plots generated). |
| B.5-t7 | T7 Complete-Even PGT landscape | ✅ done (2026-05-23) | **29588680** (1hr INTR, TIMEOUT). logZ=-14.93±0.028 (amp), -14.92±0.028 (sup). **74% floor hits** (vs T6 100%) — chi sector has more stable region but zero physical signal (max logL=-13.3, still in floor noise). ndim=18, nlive=450. Corner plots: `hpc_results/29588680/*/corner_partial.png`. |
| B.5-t8 | T8 Complete-Odd PGT landscape | ⏸ deferred to Phase E | T8 conditional NOT triggered (T6 null). `torsion_gertsenshtein_complete_odd.json` (T6+xt1-36, 38 fields, 48 H-terms) derived 2026-05-23. Landscape deferred until Phase E localised geometry resolves T6 tachyon floor issue. |
...
- 2026-05-23 — B.5-t6 — T6 fresh landscape null: 29567416 TIMEOUT 1hr, logZ=-15.07±0.022 (amp)/-15.17±0.023 (sup). 100% of 1040/1033 dead points at soft floor (logL∈[-17.8,-13.9]). Stable region (d19=d20=d21=0) has measure zero → plane-wave setup cannot survey T6. T8 conditional NOT triggered. T6/T8 landscape deferred to Phase E (localised geometry). T6-minimal corner plots generated (29515407). T7 re-derivation started (chi1-10, no R×R, ~5 min).
- 2026-05-23 — B.5-t7 — T7 landscape null: 29588680 TIMEOUT 1hr, logZ=-14.93±0.028 (amp)/-14.92±0.028 (sup). 74% floor hits (26% non-floor — chi sector more stable than T6 ε·Riem×F, but max logL=-13.3 still in floor noise band). Zero physical signal. Same conclusion as T6: plane-wave setup insufficient; Phase E required for meaningful even-sector survey. All B.5 landscape passes complete.
