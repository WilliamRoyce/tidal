...
| B.5 | D2.0–D2.3 v3 paired re-runs (8 chains) | 🚀 RESTART — first batch SUPERSEDED | **PARTITION-AUDIT BUG (2026-05-11)**: chains 29207374, 29208280, 29209010, 29209289, 29209795, 29210161, 29210726, 29228796(cancelled) were run with FEWER free parameters than v2 — D2.0 pinned ξ, D2.1 pinned δ₁, D2.2 pinned ξ+δ₁. δ₁ is the nonminimal R-F coupling that mediates torsion-photon interaction; pinning it decouples torsion entirely and reduces the inference to a trivial null (explains D2.1 "null verdict" — physically meaningless artefact). Scripts CORRECTED to match v2 exactly: D2.0 (5 params, nlive=1500), D2.1 (6 params, nlive=1800), D2.2 (8 params, nlive=2400), D2.3 (9 params, nlive=1800). Re-running cleanly: 29229768 D2.0 amp queued. |
