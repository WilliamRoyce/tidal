...
| B.5 | D2.0–D2.3 v3 paired re-runs (8 chains) | 🚀 in progress (corrected partition) | **PARTITION-AUDIT BUG (2026-05-11)** retracted: first-batch chains 29207374/29208280/29209010/29209289/29209795/29210161/29210726/29228796 SUPERSEDED. Scripts corrected to match v2 exactly. **D2.0 Bahamonde amp** 29229768 ✅ (5 free params, nlive=1500, 22 min): logZ=+9.29±0.06, joint D_KL=4.31 nats; **δ₁ carries strongest signal (D_KL=2.96 nats)** — exactly the param the buggy run pinned. sup 29232780 running. |
