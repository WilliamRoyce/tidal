...
| – | T9 Complete-Even + full ξ kinetic | TBD (≤33) | 25×ndim | 50×ndim | 2×ndim | 64 | torsion_gertsenshtein_complete_even_full_xi.json | ❌ TOML not yet written |
...
**T9 design (planned):** T7 base + full ξ₁–ξ₁₆ (∇T)² kinetic sector (16 terms, replaces single Barker ξ). Completes all ghost-free parity-even sectors. ndim TBD after plane-wave reduction (≤33: beta1-3, xi1-16, delta1, zeta1-3, chi1-10). Source: `research/lagrangian_enumeration/explicit_terms_raw.txt` DT×DT block. Barker's ξ = LC{ξ₆,ξ₇,ξ₁₂,ξ₁₆} — all 16 independent kinetic invariants required for complete survey.
...
| B.5-t8 | T8 Complete-Odd PGT landscape | ⏸ deferred to Phase E | T8 JSON derived 2026-05-23 (T6+xt1-36, 38 fields, 48 H-terms). Landscape deferred — T6 floor result means plane-wave setup cannot survey T8 meaningfully. Phase E localised geometry required first. |
...
- 2026-05-23 — Coverage audit — Identified kinetic sector gap: (∇T)² sector has 16 independent invariants (ξ₁-ξ₁₆); current theories (T5-T8) include only Barker's ξ = LC{ξ₆,ξ₇,ξ₁₂,ξ₁₆}. New T9 Complete-Even theory planned (T7 + full ξ₁-ξ₁₆ basis). TOML to be written and derived in next session. See `research/lagrangian_enumeration/explicit_terms_raw.txt` DT×DT block.
