...
- 2026-05-23 — T9 Complete-Even + full ξ kinetic — TOML written and derived (`theory_complete_even_full_xi.toml`). 33 params (beta1-3 + xi1-16 + delta1 + zeta1-3 + chi1-10); xi11 vanishes in plane-wave reduction → ndim=32. 38 fields, 48 H-terms, ~7m wall. GR smoke test passes (P_max=0.002503 vs sin²(0.05)=0.002499). Landscape sbatch written with nlive=800, num_repeats=64. Closes kinetic sector gap (T5-T8 had only Barker's single ξ = LC{ξ₆,ξ₇,ξ₁₂,ξ₁₆}).
