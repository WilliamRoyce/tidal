...
| B.5 | D2.0–D2.3 v3 paired re-runs (8 chains) | 🚀 in progress | **PARTITION-AUDIT BUG (2026-05-11)** retracted: first-batch chains 29207374/29208280/29209010/29209289/29209795/29210161/29210726/29228796 SUPERSEDED. Scripts corrected to match v2 exactly. **Strategy: INTR+resume** (see `scripts/hpc_submit_drafts/v3_permissive/README.md`). D2.0 Bahamonde amp 29229768 ✅ (22 min, logZ=+9.29±0.06, D_KL=4.31 nats). D2.0 sup 29232780 TIMEOUT→resume 29257772 🚀 running (42K dead pts, 52/165 active clusters, logZ=+6.26±0.17 — deep exploration phase; σ_logZ increasing; expect further TIMEOUTs). D2.1 Barker amp 29256858 ✅ (27 min, logZ=+9.58±0.05, D_KL=4.13 nats, 27 clusters, ESS=9517; β₂ MAP=−11.7 outside v2 prior). D2.1 sup + D2.2–D2.3 amp+sup still to submit (INTR+resume). |
