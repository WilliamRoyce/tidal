...
| ------------------ | ----------- | --------------------------------------------------------------------- |
| `run_status`       | str         | See `tidal.measurement._run_stages.RunStatus`: "success", "simulation_diverged", "solver_error", "kinetic_error", "measurement_error", "exception". ("timeout" was never emitted; "diverged" was the pre-v0.49.6 catch-all, now split — GH #480.) |
