...
> **Status: proposed by R-1 (#566), 2026-09-15.** Every entry is pinned to a source line that
> was re-read for this document. The orchestrator makes it canonical when D-A and D-B are
> recorded in `docs/COSMOLOGY_PROGRAM.md`. Where this file and `spectrum_design.md` §4.3
