...
| `R-C.md` | #567 (M3; informs #500, #501, #504) | 1 | **yes** (≤ 2 days) | **READY** 2026-09-15 — the user dispatches | `../perturbation_tooling.md`: the FRW equation set as a checklist, the literature's methods, every tool with scope/uses/torsion probe, xPand hands-on, a per-requirement recommendation (D-C) |
