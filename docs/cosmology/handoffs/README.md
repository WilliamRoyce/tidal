...
| `R-C.md` | #567 (M3; informs #500, #501, #504) | 1 | **yes** (≤ 2 days + follow-up) | **merged** 2026-09-17 (#574 + closing pass #588) — **O1′** recorded as D-C; slice ε adopted from PSALTer; the lost simplification is xBrauer's; #589 is a new xPand defect in our signature | `../perturbation_tooling.md`, `../rc_planning_record.md`; probes under `scripts/research/perturbations/`; issues #575–#586 |
| `I-532.md` | #532 (M1a) | 1 | no | **READY** 2026-09-17 — the user dispatches | `tidalcosmo/{background,spectator,validity}/`: protocol, CAMB seam, pass-through, flag schema, `../veto_placement.md` (group practice first), reference oracles + convention record, `camb` core |
