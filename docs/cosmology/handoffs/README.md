...
| `I-532.md` | #532 (M1a) | 1 | no | **dispatched** 2026-09-18 | `tidalcosmo/{background,spectator,validity}/`: protocol, CAMB seam, pass-through, flag schema, `../veto_placement.md` (group practice first), reference oracles + convention record, `camb` core |
