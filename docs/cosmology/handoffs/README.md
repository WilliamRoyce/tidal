...
| `R-C.md` | #567 (M3; informs #500, #501, #504) | 1 | **yes** (≤ 2 days + follow-up) | **merged** 2026-09-17 (#574) — recommends **O1′** for D-C; xMAG works as documented (its load-time `$RiemannSign`) | `../perturbation_tooling.md`, `../rc_planning_record.md`; probes under `scripts/research/perturbations/`; issues #575–#586 |
