...
### FRW perturbation tooling (R-C additions, 2026-09-16)

Read for `docs/cosmology/perturbation_tooling.md` (R-C, #567). The tools' own papers, the
papers that carried torsion through a Levi-Civita tool, and the comparables. Every row was
read in TeX; the lines the memo cites are in `rc_planning_record.md` §2.

| Reference | Relevance |
| --- | --- |
| **Pitrou, Roy & Umeh (2013)** — "xPand: An algorithm for perturbing homogeneous cosmologies", CQG 30, 165002, [arXiv:1302.6174](https://arxiv.org/abs/1302.6174) | The 3+1 split, SVT decomposition and gauge machinery on FRW that R-C reproduced and recommends for the metric side. Its conclusion names torsion theories as "the current exception". Two printed outputs in its Appendix A differ from the textbook and from what 0.4.4 prints (memo finding). |
| **Brizuela, Martín-García & Mena Marugán (2009)** — "xPert: Computer algebra for metric perturbation theory", GRG 41, 2415, [arXiv:0807.0824](https://arxiv.org/abs/0807.0824) | The perturbation engine under xPand; its `DefTensorPerturbation` is how a second perturbed field (torsion) is declared beside the metric, as legacy already does. |
| **Aoki, Bahamonde, Gigante Valcarcel & Gorji (2024)** — "Cosmological Perturbation Theory in Metric-Affine Gravity", PRD 110, 024017, [arXiv:2310.16007](https://arxiv.org/abs/2310.16007) | The SVT parametrization of a torsion perturbation on FRW (8 scalars, 6 transverse vectors, 2 TT tensors = 24), transcribed into Probe D's rules; also the FRW-symmetric background torsion (a vector and an axial function of time). |
| **Nikiforova & Damour (2018)** — "Infrared modified gravity with propagating torsion: instability of torsionfull de Sitter-like solutions", [arXiv:1804.09215](https://arxiv.org/abs/1804.09215) | The same 8 + 6 + 2 decomposition of a connection perturbation done by hand, with xAct "instrumental"; the cross-check for Probe D3's count. |
| **Heisenberg, Hohmann & Kuhn (2024)** — "Cosmological teleparallel perturbations", [arXiv:2311.05495](https://arxiv.org/abs/2311.05495); **Heisenberg & Hohmann** — "Gauge-invariant cosmological perturbations in general teleparallel gravity", [arXiv:2311.05597](https://arxiv.org/abs/2311.05597) | Second-order-action route for a connection perturbation on FRW, gauge-invariant variables; no computer algebra acknowledged — the by-hand precedent the memo's Part 2 records. |
| **Lu & Chee (2016)** — "Cosmology in Poincaré gauge gravity with a pseudoscalar torsion", JHEP 05 (2016) 024, [arXiv:1601.03943](https://arxiv.org/abs/1601.03943) | Scalar perturbations of a PGT cosmology with a nonzero background torsion, carried in Maple; the closest PGT precedent for what M3 must derive. |
| **Bahamonde, Gakis, Kiorpelidi, Koivisto, Levi Said & Saridakis (2021)** — "Cosmological perturbations in modified teleparallel gravity models: Boundary term extension", [arXiv:2009.02168](https://arxiv.org/abs/2009.02168) | A torsion-sector paper that used xPand — as bookkeeping beside a hand-parametrized tetrad, never as the torsion engine; how xPand has actually been used near our problem. |
| **Nicosia, Levi Said & Gakis (2021)** — "Generalised Proca Theories in Teleparallel Gravity", [arXiv:2012.11959](https://arxiv.org/abs/2012.11959) | Second xPand user with a torsionful sector (invariant table generated with xAct incl. xPand). |
| **Barker (2022)** — "Supercomputers against strong coupling in gravity with curvature and torsion", [arXiv:2206.00658](https://arxiv.org/abs/2206.00658) | HiGGS: Hamiltonian analysis of PGT on Minkowski, "grounded in" the xAct suite incl. xPand; deprecated in favor of Hamilcar (Jan 2026). Part-3 row. |
| **Hohmann (2021)** — "xPPN: An implementation of the parametrized post-Newtonian formalism using xAct for Mathematica", EPJC 81, 504, [arXiv:2012.14984](https://arxiv.org/abs/2012.14984) | The one xAct package with tetrad and torsion 3+1 machinery — built for the post-Newtonian expansion about Minkowski, backgrounds hard-wired flat; documentary row, not a candidate. |
| **Hohmann (2020)** — "General cosmological perturbations in teleparallel gravity", [arXiv:2011.02491](https://arxiv.org/abs/2011.02491); **Golovnev & Koivisto (2018)** — "Cosmological perturbations in modified teleparallel gravity models", [arXiv:1808.05565](https://arxiv.org/abs/1808.05565); **Hohmann & Pfeifer (2022)** — "Gravitational wave birefringence in spatially curved teleparallel cosmology", [arXiv:2203.01856](https://arxiv.org/abs/2203.01856); **Odintsov, Toporensky & Tretyakov (2021)** — "Spin connection and cosmological perturbations in scalar-torsion gravity", [arXiv:2110.12332](https://arxiv.org/abs/2110.12332) | The rest of the torsion-on-FRW perturbation map (teleparallel side): variables, gauge choices and which sectors each treats. |
| **Lagos, Baker, Ferreira & Noller (2016)** — "A general theory of linear cosmological perturbations: scalar-tensor and vector-tensor theories", [arXiv:1604.01396](https://arxiv.org/abs/1604.01396) | xIST/COPPER: the most general quadratic action from symmetry, not from a covariant Lagrangian — a tool for users probing theory space, not a component of our derivation. |
| **Fröb (2020)** — "FieldsX — An extension package for the xAct tensor computer algebra suite to include fermions, gauge fields and BRST cohomology", [arXiv:2008.12422](https://arxiv.org/abs/2008.12422) | Fermions, gauge fields, BRST, frame fields in xAct; no cosmology. Part-3 row. |
| **Helpin (2024)** — "Décompositions irréductibles des tenseurs via l'algèbre de Brauer et applications à la gravitation métrique-affine" (thesis), [arXiv:2407.18019](https://arxiv.org/abs/2407.18019); **Bulgakova, Goncharov & Helpin (2022)** — "Traceless Projector on (Mixed) Tensor Products", [arXiv:2212.14496](https://arxiv.org/abs/2212.14496) | The papers behind the xBrauer bundle that xMAG depends on; xMAG itself (Helpin, 0.1.0, GPL-2+) has no paper — its scope is read from its source and documentation notebooks. |
| **Gubitosi, Piazza & Vernizzi (2013)** — "The Effective Field Theory of Dark Energy", [arXiv:1210.0201](https://arxiv.org/abs/1210.0201); **Gleyzes, Langlois, Piazza & Vernizzi (2013)** — "Essential Building Blocks of Dark Energy", [arXiv:1304.4840](https://arxiv.org/abs/1304.4840); **Bellini & Sawicki (2014)** — "Maximal freedom at minimum cost: linear large-scale structure in general modifications of gravity", [arXiv:1404.3713](https://arxiv.org/abs/1404.3713) | The EFT-of-dark-energy method: α-functions hand-mapped per theory, metric only; what hi_class and EFTCAMB consume. Part-2 method. |
| **Zumalacárregui, Bellini, Sawicki, Lesgourgues & Ferreira (2017)** — "hi_class: Horndeski in the Cosmic Linear Anisotropy Solving System", [arXiv:1605.06102](https://arxiv.org/abs/1605.06102); **Bellini, Sawicki & Zumalacárregui (2020)** — "hi_class: Background Evolution, Initial Conditions and Approximation Schemes", [arXiv:1909.01828](https://arxiv.org/abs/1909.01828) | Equations hand-coded in C from the α-functions; no symbolic derivation; no torsion → Horndeski map except special cases. Part-3 row. |
| **Hu, Raveri, Frusciante & Silvestri (2014)** — "Effective Field Theory of Cosmic Acceleration: an implementation in CAMB", [arXiv:1312.5742](https://arxiv.org/abs/1312.5742); "EFTCAMB/EFTCosmoMC: Numerical Notes", [arXiv:1405.3590](https://arxiv.org/abs/1405.3590) | EFTCAMB: the EFT of dark energy inside CAMB as Fortran model classes. Part-3 row. |
| **Seery (2016)** — "CppTransport: a platform to automate calculation of inflationary correlation functions", [arXiv:1609.00380](https://arxiv.org/abs/1609.00380); **Mulryne & Ronayne (2016)** — "PyTransport: A Python package for the calculation of inflationary correlation functions", [arXiv:1609.00381](https://arxiv.org/abs/1609.00381) | Model file → symbolic core → generated numerics on flat FRW: the D-A analogue for scalar fields. |
| **Lewis, Challinor & Lasenby (2000)** — "Efficient computation of CMB anisotropies in closed FRW models", ApJ 538, 473, [arXiv:astro-ph/9911177](https://arxiv.org/abs/astro-ph/9911177) | CAMB's founding paper; the consumer of our tables and the reference for its gauge and variable names (with `camb.symbolic`). |
| **Hu & White (1997)** — "CMB anisotropies: total angular momentum method", PRD 56, 596, [arXiv:astro-ph/9702170](https://arxiv.org/abs/astro-ph/9702170) | With Seljak & Zaldarriaga above, the method WS4 follows for line-of-sight sources; recorded so the #514 derivation starts from the literature. |
| **Peeters (2007)** — "Introducing Cadabra: a symbolic computer algebra system for field theory problems", [arXiv:hep-th/0701238](https://arxiv.org/abs/hep-th/0701238) | Cadabra2 (2.5.14, GPL-3): a generic field-theory CAS with no cosmological-perturbation machinery. Part-3 row. |
