...
% ---- Metadata ---------------------------------------------------------------
\title[Amplification of the Gertsenshtein effect in PGT]%
      {Amplifying graviton--photon\\ conversion with spacetime torsion}
\author{William Royce}
\institute{Astrophysics Group, Cavendish Laboratory, University of Cambridge}
\date{\today}
...
% \input{sections/08_tidal_numerical.tex}
% \input{sections/09_inference.tex}
