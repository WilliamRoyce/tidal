\begin{frame}{\textsc{tidal}: overview}
  ...
  \vspace{0.2em}
  \emph{Every PDE derived symbolically from a single Lagrangian declaration.}

  \begin{itemize}
    \item Lagrangian varied across dozens of operator combinations.
    \item Tensor calculus intractable by hand at this generality.
    \item Symbolic computation the only viable route.
  \end{itemize}
\end{frame}
