\begin{frame}{\textsc{tidal}: overview}
  ...
  \begin{itemize}
    \item Lagrangian varied across \emph{dozens} of operator combinations.
    \item At this level of generality, the tensor calculus becomes intractable by hand
    \item \emph{Symbolic computation} is the only viable route.
  \end{itemize}
\end{frame}
