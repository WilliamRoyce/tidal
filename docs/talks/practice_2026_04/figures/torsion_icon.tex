...
% 2024 Cambridge brand palette — Cherry family.
% Use the brand colours directly (no percent-blends).
\definecolor{Cambridge24LightCherry}{HTML}{F2CAD8}
\definecolor{Cambridge24WarmCherry}{HTML}{E18AAC}
...
\begin{tikzpicture}[line cap=round]
    ...
    \fill[PurpleFill, opacity=0.7] (O) -- (Q) to[bend right=15] (Ru) -- (R) -- cycle;
    \fill[PurpleFill, opacity=0.7] (O) -- (R) to[bend left=15] (Qv) -- (Q) -- cycle;
