...
\emph{any} vacuum gravitational wave.  Torsion amplification requires either
non-minimal torsion--EM coupling terms (e.g.\ $T \cdot F$, $T \cdot {*F}$) or a
formulation that avoids Ostrogradsky instability.
