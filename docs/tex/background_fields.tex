...
(Gertsenshtein 1962; Palessandro \& Rothman 2023~\cite{palessandro2023simple}), where a static external
...
\begin{itemize}
  ...
  \item Domcke, Garcia-Cely \& Lee~(2025)~\cite{domcke2025scattering} --- inhomogeneous $B(z)$, 3D scattering
\end{itemize}
...
\begin{itemize}
  ...
  \item Palessandro \& Rothman (2023), ``A simple derivation of the Gertsenshtein effect'', Phys.\ Dark Univ.\ 40, 101187, arXiv:2301.02072~\cite{palessandro2023simple} --- simple Dyson-style derivation; note that their formula has a $\sqrt{4\pi}$ normalisation error (see~\cref{sec:gertsenshtein-formula})
