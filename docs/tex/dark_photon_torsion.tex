...
combination of Gertsenshtein~\cite{Gertsenshtein1962} graviton--photon
...
$\kappa^2 = 16\pi G$ is the gravitational coupling. A
...
\begin{description}
  ...
  \item[Chern--Simons $\phi F \tilde{F}^{(t)}$.]
    ...
    Raffelt--Stodolsky~\cite{RaffeltStodolsky1988} axion-photon
    mixing.
  \item[Non-minimal gravitational coupling.] A dimension-6 operator
    ...
    \cite{Itin2003} and \cite{Rubilar2003}.
