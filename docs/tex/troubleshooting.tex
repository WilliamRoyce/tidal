...
\textbf{Caveat:} After reduction, some equations may contain implicit cross-references to accelerations of other 2nd-order fields (e.g., $\partial_t^2 q_j$ in $q_i$'s equation). This requires further solver support (issue \#165).
