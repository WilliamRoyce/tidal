...
\texttt{--gated} restores the pre-v3 hard rejection on both
\texttt{tidal sample} and \texttt{tidal sweep}.  It exists so archived
v2 chains and April-2026 sweeps can be reproduced bit-for-bit, and is
\textbf{not} a physics option.
