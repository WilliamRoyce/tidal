...
parameter space where no $B$ field achieves $P_\text{final} \geq 0.99$ produce $B_\text{min} =
\text{NaN}$, shown as blank spots on heatmaps --- which is itself informative.
