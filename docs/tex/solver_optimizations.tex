...
\midrule
\multicolumn{3}{@{}l}{\emph{Derivation-side optimisations (v0.15.0+)}} \\
Component E--L & Component-level Euler--Lagrange (default) & $>$900$\times$ for higher-derivative theories \\
CD shorthand & Pre-computed covariant derivative expansions & 3$\times$ xPert linearisation speedup \\
\bottomrule
\end{tabular}
\end{table}
