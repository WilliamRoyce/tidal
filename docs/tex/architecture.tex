...
After reduction, some equations may contain implicit references to accelerations of other fields (e.g., $\partial_t^2 q_j$ appearing in $q_i$'s equation where $q_j$ is itself a second-order field). Resolving these implicit cross-references requires either IDA's residual formulation or explicit RHS substitution during reduction. This is tracked in issue \#165.
