...
For the full schema reference, see the JSON Schema Guide.\footnote{\url{https://github.com/WilliamRoyce/torsion-gertsenshtein/blob/main/docs/JSON\_SCHEMA\_GUIDE.md}}
