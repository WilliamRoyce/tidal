...
| **xPand's slice (spatial) Levi-Civita tensor relative to `ε` and the normal — not checked** | a kernel probe before the parity-odd torsion rules are used | R-C's closing pass is writing that probe (branch `cosmo/rc-closing-pass`, 2026-09-17) | `perturbation_tooling.md` §1.2, §7.3 |
