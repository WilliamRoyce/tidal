...
| 1 | I-532 — CAMB seam, background protocol, flag schema, veto placement | #532 | — | `tidalcosmo/{background,spectator,validity}/`, `tests_cosmo/data/camb_oracles/`, `docs/cosmology/veto_placement.md`, `pyproject.toml` (camb line only) | `cosmo/i532-camb-seam` | **ready** 2026-09-17 — the user dispatches (R-C merged; D-C recorded) |
...
> **State, 2026-09-17. Wave 1: R-1 and R-C MERGED, D-C recorded (O1′); I-532 READY. Wave 0, its completion wave and the hardening pass are COMPLETE, and
