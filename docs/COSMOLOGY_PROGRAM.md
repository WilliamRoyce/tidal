...
| 1 | R-C — cosmological perturbations: requirements, methods, tools (decides D-C) | #567 | **yes** (≤ 2 days) | `docs/cosmology/perturbation_tooling.md`, `scripts/research/perturbations/`, additive `Applications/xAct/xPand/` | `cosmo/rc-perturbation-tooling` | **dispatched** 2026-09-15 — **holds the Wolfram lane** (≤ 2 days) |
...
> **State, 2026-09-15. Wave 1: R-1 MERGED, R-C DISPATCHED. Wave 0, its completion wave and the hardening pass are COMPLETE, and
