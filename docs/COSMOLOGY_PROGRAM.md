...
| **xPand's slice (spatial) Levi-Civita tensor relative to `ε` and the normal — not checked** | a kernel probe before the parity-odd torsion rules are used | before O4-aniso work | `perturbation_tooling.md` §1.2, §7.3 |
