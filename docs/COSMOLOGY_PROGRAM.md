...
| **Upstream, the user's to send** — [xMAG #2](https://github.com/THelpin/xMAG/issues/2) was filed with **three errors of ours**, and a correction comment is drafted; also drafted, not sent: the xBrauer contraction issue and the xPand email with four scripts. Every claim is checked in `upstream/claims.md` | the user | **soon for xMAG #2** — a public issue carrying our errors | `scripts/research/perturbations/upstream/` |
